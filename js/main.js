...
function generatePictures() {
  for (var i = 0; i < PICTURES_NUM; i++) {
    ...
    var description = descriptionArray[randNumGen(descriptionArray.length)];

    pictures.push({url: url, likes: likes, comments: comments, description: description});
  }
};
